                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                                All over tamilnadu we are having branches,
                                we provide top class cleaning for you cars.
                                our head office is located at coimbatore.
                                
                                CEO-Vaishnav ram.k
                                CFO-Vishnu vardhan.G
                                TECHNICAL HEAD- Rishi khanna.P.R
                            </p>
                            <ul>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs.</span><strong>350</strong><span>.00</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>RS.</span><strong>600</strong><span>.00</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                                    ...
                                    <li><i class="far fa-check-circle"></i>Interior Wet Cleaning</li>
                                    <li><i class="far fa-times-circle"></i>Window Wiping</li>
                                    <li><i class="far fa-times-circle"></i>Teflon coating</li>
                                </ul>
                            </div>
                            <div class="price-footer">
                                <a class="btn btn-custom"  data-toggle="modal" data-target="#myModal">Book Now</a>
                        ...
                        <div class="price-item">
                            ...
                            <div class="price-body">
                                <ul>
                                    ...
                                    <li><i class="far fa-check-circle"></i>Interior Wet Cleaning</li>
                                    <li><i class="far fa-check-circle"></i>Window Wiping</li>
                                    <li><i class="far fa-times-circle"></i>graphine coating </li>
                                    <li><i class="far fa-times-circle"></i>sound system equliser</li>
                                </ul>
                            </div>
                            <div class="price-footer">
                                <a class="btn btn-custom"  data-toggle="modal" data-target="#myModal">Book Now</a>
  ...
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (RS.350)</option>
                 <option value="2">PREMIUM CLEANING (RS.600)</option>
                  <option value="3 ">COMPLEX CLEANING(RS.1500)</option>
              </select>
